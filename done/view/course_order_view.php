<?php
class course_order_view
{
    public function __construct($search_value, $orderby, $query, $numCourses)
    {
...
<section id="intro">
    ...
    <thead>
        <th data-sort-ignore="true" width="5%">Rating</th>
          ...
          <th data-sort-ignore="true" width="13%"><input type="hidden" name="controller" value="orderby" form="my4_form">
...
?>" form="my_form">
        ...
        while ($nextpage != $lastpage) {
            $nextpage = $nextpage + 1;
            echo " <a href='?query=$query&controller=orderby&orderby=$orderby&st=$start&ed=$rows_per_page&submit=Search'>   $nextpage  </a> ";
